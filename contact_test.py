...
class TestContact(unittest.TestCase):
    def setUp(self):
        self.new_contact = Contact("Dominic", "Kiprotich", "0712345678", "kip@gmail.com")

    def tearDown(self):
        Contact.contact_list = []

    def test_init(self):
        self.assertEqual(self.new_contact.first_name, "Dominic")
        self.assertEqual(self.new_contact.last_name, "Kiprotich")
        self.assertEqual(self.new_contact.phone_number, "0712345678")
        self.assertEqual(self.new_contact.email, "kip@gmail.com")
